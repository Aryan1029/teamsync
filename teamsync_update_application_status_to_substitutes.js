...
const app = express();
const port = 3011; // Choose your desired port number
...
app.put('/substitute-applicant', (req, res) => {
  ...
  const values = ['substituted', applicantName];
  ...
  db.query(sql, values, (err, result) => {
    if (err) {
      ...
      console.log(`Updated status for ${applicantName} to 'substituted'`);
