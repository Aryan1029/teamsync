...
class rejected_applicant_final_profile_page extends StatefulWidget {
  final Map<String, dynamic> applicant;

  const rejected_applicant_final_profile_page({Key? key, required this.applicant})
      : super(key: key);

  @override
  State<rejected_applicant_final_profile_page> createState() => _rejected_applicant_final_profile_pageState();
}

class _rejected_applicant_final_profile_pageState extends State<rejected_applicant_final_profile_page> {
  @override
