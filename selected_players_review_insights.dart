...
class selected_players_review_insights extends StatefulWidget {
  const selected_players_review_insights({super.key});

  @override
  State<selected_players_review_insights> createState() => _selected_players_review_insightsState();
}

class _selected_players_review_insightsState extends State<selected_players_review_insights> {
  int applicantCount = 0; // Initialize the count to 0
  @override
  Future<void> fetchApplicants() async {
    final response = await http.get(Uri.parse('http://192.168.0.106:3010/selected_applicant_list?'));
              ...
              child: ListView(
                children: [
                  Container(
                    ...
                    child:selected_players_widget(updateCallback: () async {
