...
class approved_applicants_review_insights extends StatefulWidget {
  const approved_applicants_review_insights({super.key});

  @override
  State<approved_applicants_review_insights> createState() => _approved_applicants_review_insightsState();
}

class _approved_applicants_review_insightsState extends State<approved_applicants_review_insights> {
