...
class approved_applicant_final_profile_page extends StatefulWidget {
  final Map<String, dynamic> applicant;

  const approved_applicant_final_profile_page({Key? key, required this.applicant})
      : super(key: key);

  @override
  State<approved_applicant_final_profile_page> createState() => _approved_applicant_final_profile_pageState();
}

class _approved_applicant_final_profile_pageState extends State<approved_applicant_final_profile_page> {
  @override
