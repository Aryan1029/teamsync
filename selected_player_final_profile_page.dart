...
class selected_player_final_profile_page extends StatefulWidget {
  final Map<String, dynamic> applicant;

  const selected_player_final_profile_page({Key? key, required this.applicant})
      : super(key: key);

  @override
  State<selected_player_final_profile_page> createState() => _selected_player_final_profile_pageState();
}

class _selected_player_final_profile_pageState extends State<selected_player_final_profile_page> {
  @override
