...
class apply extends StatefulWidget {
  ...
  const apply({super.key, required this.email});
                        ...
                        child: DropdownButton<String>(
                          ...
                          <String>['right', 'left'].map((String st_foot) {
                            return DropdownMenuItem<String>(
                              value: st_foot,
                              child: Padding(
                                padding: EdgeInsets.fromLTRB(55,0,51,0),
                                child: Text(
                                  textAlign: TextAlign.center,
                                  st_foot,
                                  style: TextStyle(
...
// Call this function when the submit button is pressed
  Future<void> onApplicationSubmit(BuildContext context,String mailid) async {
    ...
    // Gather applicant's data and create a map
    ...
    print(deviceToken);
    // Call the submitApplication function to send the data to your API
    submitApplication(context,applicationData);
  }
