...
import '../widgets/rejected_applicant_list_widget.dart';
import 'created_teams.dart';

class rejected_applicants_review_insights extends StatefulWidget {
  const rejected_applicants_review_insights({super.key});

  @override
  State<rejected_applicants_review_insights> createState() => _rejected_applicants_review_insightsState();
}

class _rejected_applicants_review_insightsState extends State<rejected_applicants_review_insights> {
  int applicantCount = 0; // Initialize the count to 0
  @override
  Future<void> fetchApplicants() async {
    final response = await http.get(Uri.parse('http://192.168.0.106:3007/rejected_applicant_list?'));
              ...
              child: ListView(
                children: [
                  Container(
                    ...
                    child:rejected_applicant_list_widget(updateCallback: () async {
